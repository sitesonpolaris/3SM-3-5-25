...
function FoodJusticeMission() {
  const values = [
    ...
    },
    {
      ...
      image: "https://static.wixstatic.com/media/c73eb8_bc3a0cdbe8b0456497305723ae676e3b~mv2.jpg"
    },
    {
      title: "Equality",
      description: "All members have equal rights and responsibilities within the cooperative.",
      icon: <IoLeaf className="w-8 h-8" />,
      image: "https://static.wixstatic.com/media/c73eb8_e38644371cf94bf991b82e14b2d2cb18~mv2.jpg"
    },
    {
      title: "Equity",
      description: "Members contribute fairly and receive benefits in proportion to their participation.",
      icon: <IoPeople className="w-8 h-8" />,
      image: "https://static.wixstatic.com/media/c73eb8_32b54dc448164e1e97a7a1b297ece4c0~mv2.jpg"
    },
    {
      title: "Solidarity",
